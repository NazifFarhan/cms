...
<body>
	...
	<%
		...
		if( session.getAttribute("userType") == null )
			...
			String nextPage = userType+"DeleteCourse.jsp";
			if(nextPage.equals("adminDeleteCourse.jsp") == false)
...
<div class="sidebar">
  ...
  <a class="active" href="adminDeleteCourse.jsp"> Delete Course</a>
...
<div class="content">
	<%		
			if(session.getAttribute("courseDeleted") != null)	{
	%>
			<div class="alert alert-success" role="alert" style="text-align: center;">
  				Course deleted successfully!
			</div>
	<% 
				session.removeAttribute("courseDeleted");
			}
	%>
